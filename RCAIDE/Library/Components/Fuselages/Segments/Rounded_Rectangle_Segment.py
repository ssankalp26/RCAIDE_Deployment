# RCAIDE/Library/Compoments/Fuselage/Rounded_Rectangle_Segment.py
# 
...
class Rounded_Rectangle_Segment(Segment):
    """
    A component representing a rounded rectangular cross-sectional segment of a fuselage. Segments are used 
